...
class SettingPinActivity : AppCompatActivity(), View.OnClickListener {
            ...
            if(myPassword.isNullOrEmpty()) {
                ...
                if (myPassword != _pin) {
                    ...
                    viewModel.onSavePIN(myPassword!!).observe(this,{
                        ...
                        Toast.makeText(this,resources.getString(R.string.text_create_password_success),Toast.LENGTH_SHORT).show()
    ...
    private fun onClose(){
        val screen = intent.getStringExtra(SplashScreenActivity.KEYS)
        when(screen){
            SplashScreenActivity.HOME_SCREEN ->{
                startActivity(Intent(this, HomeActivity::class.java))
                overridePendingTransition(R.anim.abc_fade_in, R.anim.abc_fade_out)
                finish()
            }

            SplashScreenActivity.WELCOME_SCREEN ->{
                startActivity(Intent(this, WelcomeActivity::class.java))
                overridePendingTransition(R.anim.abc_fade_in, R.anim.abc_fade_out)
                finish()
            }

            SplashScreenActivity.LOCK_SCREEN ->{
