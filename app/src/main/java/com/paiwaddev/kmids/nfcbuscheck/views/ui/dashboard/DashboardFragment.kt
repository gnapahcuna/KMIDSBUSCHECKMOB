package com.paiwaddev.kmids.nfcbuscheck.views.ui.dashboard
...
import com.paiwaddev.kmids.nfcbuscheck.views.ui.SettingPinActivity
import com.paiwaddev.kmids.nfcbuscheck.views.ui.SplashScreenActivity
import org.koin.android.ext.android.get
import org.koin.core.parameter.parametersOf

class DashboardFragment : Fragment(), SettingsAdapter.ItemListener, SettingsAdapter.SwitchListener  {
    ...
    override fun onItemClicked(setting: SettingModel) {
        ...
        if(setting.isActionId == 1){
            ...
            activity?.let{
                ...
                intent.putExtra(SplashScreenActivity.KEYS,SplashScreenActivity.HOME_SCREEN)
